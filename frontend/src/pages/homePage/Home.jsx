...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className="info2">
                <h3>TAK NEVÁHAJTE!</h3>
                <p1>a zúčastnite sa študentskej vedeckej konferencie, ktorá je súťažnou prehliadkou vedeckých prác študentov</p1>
                <div className="details-container">
                    <p2>Termín konania: To be announced</p2>
                    <p2>Miesto konania: UKF v Nitre</p2>
                </div>
            </div>

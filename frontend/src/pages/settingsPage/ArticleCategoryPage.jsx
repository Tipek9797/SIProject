    ...
    const toolbarTemplate = () => {
        return (
            <React.Fragment>
                ...
                <Button label="Pridať Kategóriu Článkov" icon="pi pi-plus" onClick={openNewCategoryDialog} />
                <Button label="Vymazať Vybrané Kategórie" icon="pi pi-trash" className="p-button-danger" onClick={deleteSelectedCategories} disabled={!selectedCategories.length} />
            </React.Fragment>
        );
    };
